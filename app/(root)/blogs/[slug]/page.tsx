    ...
    <div className="pt-[15vh] max-w-5xl mx-auto">
      ...
      <div className="flex items-center flex-wrap max-md:justify-center gap-4 mt-4">
        <div className="flex items-center gap-2">
          <Image src="/author/j.jpg" alt="author" width={30} height={30} className="object-cover rounded-sm" />
          <p>by Jasur</p>
        </div>
        <Minus />
        <div className="flex items-center gap-2">
      ...
      <Image src="/blogs/04.jpg" alt="alt" width={1120} height={595} className="mt-4 rounded-md" />
        ...
        <div className="flex flex-col space-y-3">
          <div className="sticky top-36">
            ...
            <div className="flex flex-col max-md:flex-row md:space-y-3 max-md:space-x-3 mt-4">
              {[Twitter, Facebook, Linkedin, Send, Link2].map((Icon, i) => (
      ...
      <div className="flex mt-6 gap-6 items-center max-md:flex-col">
        <Image src="/author/j.jpg" alt="author" width={155} height={155} className="rounded-md max-md:self-start" />
        <div className="flex-1 flex flex-col space-y-4">
          <h2 className="text-3xl font-creteRound">Jasur Ungarov</h2>
          <p className="line-clamp-2 text-muted-foreground">
            Jasur Ungarov is a writer based in New York City. Hi is interested in all things tech, scienca, and likes to yo-yo in
          </p>
