    ...
    <div className="max-w-6xl mx-auto">
      <div className="relative min-h-[40vh] flex items-center justify-end flex-col">
        ...
        <div className="flex gap-1 items-center mt-4">
          ...
          <Link href="/" className="opacity-90 hover:underline hover:opacity-100">Home</Link>
          <Dot />
          <Link href="/blogs" className="opacity-90 hover:underline hover:opacity-100">Blogs</Link>
          <Dot />
      ...
      <div className="flex flex-col space-y-2 mt-8">
        {Array(2).fill(0).map((_, i) => (
          <div key={i} className="flex gap-2 text-lg text-muted-foreground">
            <p>05 Dec</p>
